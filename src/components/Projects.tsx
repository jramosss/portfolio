  ...
  return (
    <div className='flex flex-col justify-center items-center gap-4'>
      ...
      <div className='flex flex-col justify-center items-center gap-4 mt-2'>
        ...
        />
        <ProjectItem
          name='Cifraclub List to PDF - Benchmark'
          since='December 2024'
          to='Present'
          description={
            'A simple implementation of a scraper across many programming languages where i benchmarked the performance of each implementation.'
          }
          link='https://github.com/jramosss/cifraclub-list-to-pdf-all-langs'
          technologies={['Programming Languages', 'Benchmarking']}
        />
      </div>
    </div>
  );
